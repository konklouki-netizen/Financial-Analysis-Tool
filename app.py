# app.py (FINAL STABLE - Integrated)
            ...
            if input_mode == "Yahoo" and ticker_in:
                ...
                for t in tickers:
                    ...
                    if data:
                        ...
                        if t != main_ticker:
                            try: sector_stats['ROE'].append(forensics['Analysis']['5_Management']['ROE'])
                            except: pass

                analysis_group['benchmark'] = {k: sum(v)/len(v) for k, v in sector_stats.items() if v}
...
if st.session_state.current_group:
    ...
    def ui_card(label, value, subtext=None, color="#2c3e50"):
        border_c = "#3498db"
        if "RED" in str(subtext): border_c = "#e74c3c"
        elif "OK" in str(subtext): border_c = "#27ae60"
